...
transactionLogLabel = Label(accountFrame, text="Last Three Transactions: ", padx=10, pady=10, bg='#343332', fg='gray',
                           font='Times 10 bold')

transactionOne = Label(accountFrame, text="69", padx=10, pady=10, bg='#343332', fg='gray',
                           font='Times 10 bold')

transactionTwo = Label(accountFrame, text="69", padx=10, pady=10, bg='#343332', fg='gray',
                           font='Times 10 bold')

transactionThree = Label(accountFrame, text="69", padx=10, pady=10, bg='#343332', fg='gray',
                           font='Times 10 bold')
